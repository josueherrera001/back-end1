/*
  ...
  - You are about to drop the column `Description` on the `accountmenus` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE `accountmenus` DROP COLUMN `Description`,
